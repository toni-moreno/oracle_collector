...
CREATE PROFILE "C##PROFILE_MONIT" LIMIT COMPOSITE_LIMIT UNLIMITED SESSIONS_PER_USER UNLIMITED CPU_PER_SESSION UNLIMITED CPU_PER_CALL UNLIMITED LOGICAL_READS_PER_SESSION UNLIMITED LOGICAL_READS_PER_CALL UNLIMITED IDLE_TIME UNLIMITED CONNECT_TIME UNLIMITED PRIVATE_SGA UNLIMITED FAILED_LOGIN_ATTEMPTS 10 PASSWORD_LIFE_TIME UNLIMITED PASSWORD_REUSE_TIME UNLIMITED PASSWORD_REUSE_MAX UNLIMITED PASSWORD_VERIFY_FUNCTION NULL PASSWORD_LOCK_TIME UNLIMITED PASSWORD_GRACE_TIME UNLIMITED;
-- Crear el usuario
CREATE USER C##MONIT IDENTIFIED BY "XXXYYY" PROFILE C##PROFILE_MONIT;
ALTER USER C##MONIT QUOTA UNLIMITED ON USERS;
GRANT ALTER SESSION TO C##MONIT;
GRANT CREATE SESSION TO C##MONIT;
-- GRANT CREATE TABLE TO C##MONIT;
...
--GRANT SELECT ON DBA_TABLESPACE_METRICS TO C##MONIT;
...
ALTER USER C##MONIT SET CONTAINER_DATA = ALL FOR SYS.V_$PDBS CONTAINER = CURRENT;
EXIT;
